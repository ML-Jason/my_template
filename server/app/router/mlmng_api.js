...
module.exports = (app) => {
  ...
  // 針對/mlmng/api開啟CORS，如果要對所有網站開啟，則將origin設為true
  const corsOption = {
  ...
  // 設定api的ratelimit
  const ratelimit = new RateLimit({ name: 'mlmngapi', max: '120', time: '60' });
  ...
  router.get('/updatetoken', middles.parseToken, login.updatetoken);
