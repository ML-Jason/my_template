...
module.exports = (router) => {
  router.post('/user', middles.verifyToken, middles.needAdmin, (req, res, next) => {
    // 驗證帳號
   ...
   */
  router.get('/user/:id', middles.verifyToken, (req, res, next) => {
   ...
   * @apiSampleRequest /auth/api/user
   */
  router.put('/user/:id', middles.verifyToken, (req, res, next) => {
    const _id = validators.toNormalStr(req.params.id);
   ...
   * @apiSampleRequest /auth/api/user
   */
  router.delete('/user/:id', middles.verifyToken, middles.needAdmin, (req, res, next) => {
    const _id = validators.toNormalStr(req.params.id);
    if (!_id) {
      next('E004001');
    } else {
   ...
   */
  router.get('/users', middles.verifyToken, (req, res, next) => {
